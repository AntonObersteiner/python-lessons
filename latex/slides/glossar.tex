...
\begin{frame}{Variable}
	\codewithsource{resources/glossar/variables.py}
	\begin{itemize}
...
\begin{frame}{if-elif-else}
	\codewithsource{resources/glossar/if_elif_else.py}
	\begin{itemize}
...
\begin{frame}{print und input}
	\codewithsource{resources/glossar/print_input.py}
	\begin{itemize}
...
\begin{frame}{Funktionen}
	\codewithsource{resources/glossar/function.py}
	\begin{itemize}
...
\begin{frame}{Datentypen}
	...
	\end{description}
	\codewithsource{resources/glossar/datatypes.py}
\end{frame}
...
\begin{frame}{Operatoren}
	...
	\end{description}
	\codewithsource{resources/glossar/operators.py}
\end{frame}
\begin{frame}{Operatoren}
	\begin{description}
		\item[\tt==] gleich?
	...
	\end{description}
	\codewithsource{resources/glossar/operators_bool.py}
\end{frame}
...
\begin{frame}{Listen}
	...
	\end{itemize}
	\codewithsource{resources/glossar/list_squares.py}
\end{frame}
...
\begin{frame}{\texttt{for}-Loop und \texttt{range}}
	...
	\end{itemize}
	\codewithsource{resources/glossar/for_range.py}
\end{frame}
...
\begin{frame}{\texttt{while}-Loop}
	...
	\end{itemize}
	\codewithsource{resources/glossar/while.py}
\end{frame}
...
\begin{frame}{\texttt{continue} und \texttt{break}}
	...
	\end{description}
	\codewithsource{resources/glossar/continue_break.py}
\end{frame}
...
\subsection{Files}
\begin{frame}{Files}
	\codewithsource{resources/glossar/files.py}
	\codewithsource{resources/glossar/files_with.py}
\end{frame}

\subsection{Exception}
\begin{frame}{Files}
	\codewithsource{resources/glossar/exception.py}
	\codewithsource{resources/glossar/exception_file.py}
\end{frame}
...
\begin{frame}{Klassen und Attribute}
	...
	\end{itemize}
	\onslide<3->\codewithsource{resources/02_grundlagen/class.py}
...
\begin{frame}{Attribute}
	...
	\codewithsource{resources/02_grundlagen/attributes.py}
...
\begin{frame}{Super- und Subklassen}
	...
	\end{itemize}
	\codewithsource{resources/02_grundlagen/inheritance.py}
\end{frame}
