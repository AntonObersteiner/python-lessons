...
\begin{frame}{Parameter?}
	\lstinputlisting{resources/02_grundlagen/scope_parameter.py}
...
\begin{frame}{Funktionaler Ansatz}
	\lstinputlisting{resources/02_grundlagen/scope_functional.py}
...
\begin{frame}{Beispiel: Mein Vektor}
    \lstinputlisting{resources/02_grundlagen/Vector_short.py}
\end{frame}
